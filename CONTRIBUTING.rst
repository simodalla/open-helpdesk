...
open-helpdesk could always use more documentation, whether as part of the 
official open-helpdesk docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork the `open-helpdesk` repo on GitHub.
...
3. The pull request should work for Python 2.6, 3.3, and 3.4. Check
