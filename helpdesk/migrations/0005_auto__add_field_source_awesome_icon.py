...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source.awesome_icon'
        db.add_column('helpdesk_source', 'awesome_icon',
                      self.gf('django.db.models.fields.CharField')(null=True, blank=True, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source.awesome_icon'
        db.delete_column('helpdesk_source', 'awesome_icon')
    ...
    models = {
        ...
        'helpdesk.activity': {
            ...
            'co_maker': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'co_maker_of_activities'", 'null': 'True', 'to': "orm['auth.User']", 'blank': 'True', 'symmetrical': 'False'}),
            'content': ('mezzanine.core.fields.RichTextField', [], {}),
            'created': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'maker': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'maker_of_activities'", 'to': "orm['auth.User']"}),
            'report': ('django.db.models.fields.related.OneToOneField', [], {'unique': 'True', 'null': 'True', 'to': "orm['helpdesk.Report']", 'blank': 'True'}),
            'scheduled_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'ticket': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'activities'", 'null': 'True', 'to': "orm['helpdesk.Ticket']", 'blank': 'True'}),
        ...
        'helpdesk.message': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'recipent_of_messages'", 'null': 'True', 'to': "orm['auth.User']", 'blank': 'True'}),
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sender_of_messages'", 'to': "orm['auth.User']"}),
            'ticket': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'messages'", 'null': 'True', 'to': "orm['helpdesk.Ticket']", 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'null': 'True'})
        },
        ...
        'helpdesk.source': {
            ...
            'awesome_icon': ('django.db.models.fields.CharField', [], {'null': 'True', 'blank': 'True', 'max_length': '100'}),
            'code': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'helpdesk_sources'", 'to': "orm['sites.Site']", 'blank': 'True', 'symmetrical': 'False'}),
        ...
        'helpdesk.ticket': {
            ...
            'assignee': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'assigned_tickets'", 'null': 'True', 'to': "orm['auth.User']", 'blank': 'True'}),
            'content': ('mezzanine.core.fields.RichTextField', [], {}),
            'created': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'insert_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'inserted_tickets'", 'to': "orm['auth.User']"}),
            'priority': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'related_tickets': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'related_tickets_rel_+'", 'to': "orm['helpdesk.Ticket']", 'blank': 'True'}),
        ...
        'helpdesk.tipology': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'priority': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'helpdesk_tipologies'", 'to': "orm['sites.Site']", 'blank': 'True', 'symmetrical': 'False'}),
